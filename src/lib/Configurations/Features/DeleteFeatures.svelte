<script>
  ...
  const handleDelete = async () => {
    try {
      isExcuting = true
      const resDelete = await API.deleteFeatures(info.id)
...
<div class="body_wrapper">
  <div class="popup_wrapper">
    <div class="pop_header">
      <h5 class="mb-0 fw-bold">Delete feature</h5>
    ...
    <div class="action_body">
      <span class="mt-3"
        ...
        /></span
      >
      <p class="fw-bold">Are you sure deleting this feature?</p>
      <small>Note: This feature will be delete on stripe </small>
    </div>
